...
const AuthPage = () => {
  return (
    <div className="grid h-screen w-screen place-items-center px-4 text-sm font-medium bg-black">
      <div>
        <div className="text-white flex items-center">
          <Image alt="Logo" src="/logo.png" width={50} height={30} />
          <h1 className="ml-3 text-5xl text-center">Trubbi</h1>
        </div>
        <h3 className="mt-3 text-3xl text-white block">Fast and Helpful AI</h3>
      </div>
